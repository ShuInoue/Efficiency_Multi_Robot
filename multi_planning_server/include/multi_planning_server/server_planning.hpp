...
search_length(0.3),
avoid_target(1),
receive_robot_path_wait_time(4)
{
    ...
    target2robot1 = t2r1.advertise<geometry_msgs::PoseStamped>("/robot1/check_target",1);
    target2robot2 = t2r2.advertise<geometry_msgs::PoseStamped>("/robot2/check_target",1);
    robot1_final_target_pub = robot1_final_target_nh.advertise<geometry_msgs::PoseStamped>("/robot1/move_base_simple/goal",1);
    robot2_final_target_pub = robot2_final_target_nh.advertise<geometry_msgs::PoseStamped>("/robot2/move_base_simple/goal",1);
